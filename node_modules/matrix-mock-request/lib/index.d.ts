...
declare class HttpBackend {
    ...
    fetchFn: (input: URL | string, init?: Omit<RequestOpts, 'uri'> & {
        signal?: AbortSignal;
    }) => Promise<{
        ok: boolean;
        status: number;
     ...
     */
    flushSync(path: string | undefined, numToFlush?: number): number;
    /**
     ...
     */
    when: (method: HttpMethod, path: string, data?: any) => ExpectedRequest;
    /**
...
declare class ExpectedRequest {
    ...
    constructor(method: HttpMethod, path: string, data?: any);
    toString: () => string;
    /**
