...
exports.FALLBACK_ICE_SERVER = FALLBACK_ICE_SERVER;
...
class MatrixCall extends _typedEventEmitter.TypedEventEmitter {
  ...
  constructor(opts) {
    ...
    (0, _defineProperty2.default)(this, "iceReconnectionTimeOut", void 0);
    ...
    (0, _defineProperty2.default)(this, "isSettingRemoteAnswerPending", false);
    ...
    (0, _defineProperty2.default)(this, "onIceConnectionStateChanged", () => {
      ...
      _logger.logger.debug(`Call ${this.callId} onIceConnectionStateChanged() running (state=${(_this$peerConn2 = this.peerConn) === null || _this$peerConn2 === void 0 ? void 0 : _this$peerConn2.iceConnectionState}, conn=${(_this$peerConn3 = this.peerConn) === null || _this$peerConn3 === void 0 ? void 0 : _this$peerConn3.connectionState})`);
      ...
      if (["connected", "completed"].includes((_this$peerConn$iceCon = (_this$peerConn4 = this.peerConn) === null || _this$peerConn4 === void 0 ? void 0 : _this$peerConn4.iceConnectionState) !== null && _this$peerConn$iceCon !== void 0 ? _this$peerConn$iceCon : "")) {
        ...
        if ((_this$peerConn6 = this.peerConn) !== null && _this$peerConn6 !== void 0 && _this$peerConn6.restartIce) {
          var _this$peerConn7;
          this.candidatesEnded = false;
          _logger.logger.debug(`Call ${this.callId} onIceConnectionStateChanged() ice restart (state=${(_this$peerConn7 = this.peerConn) === null || _this$peerConn7 === void 0 ? void 0 : _this$peerConn7.iceConnectionState})`);
    ...
    (0, _defineProperty2.default)(this, "onSignallingStateChanged", () => {
      ...
      _logger.logger.debug(`Call ${this.callId} onSignallingStateChanged() running (state=${(_this$peerConn12 = this.peerConn) === null || _this$peerConn12 === void 0 ? void 0 : _this$peerConn12.signalingState})`);
    });
  ...
  getRidOfRTXCodecs() {
    ...
    screenshareVideoTransceiver === null || screenshareVideoTransceiver === void 0 ? void 0 : (_screenshareVideoTran = screenshareVideoTransceiver.setCodecPreferences) === null || _screenshareVideoTran === void 0 ? void 0 : _screenshareVideoTran.call(screenshareVideoTransceiver, codecs);
  }
  /**
   * @internal
   */
  ...
  createPeerConnection() {
    ...
    (_this$stats3 = this.stats) === null || _this$stats3 === void 0 ? void 0 : _this$stats3.addStatsReportGatherer(this.callId, opponentMemberId, pc);
    return pc;
  }
  partyIdMatches(msg) {
  ...
  chooseOpponent(ev) {
    ...
    if (this.opponentMember) {
      var _this$stats4;
      (_this$stats4 = this.stats) === null || _this$stats4 === void 0 ? void 0 : _this$stats4.updateOpponentMember(this.callId, this.opponentMember.userId);
    }
  }
