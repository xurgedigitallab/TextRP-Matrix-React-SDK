...
class TrackStatsBuilder {
  ...
  static setTrackStatsState(trackStats, transceiver) {
    ...
    const track = trackStats.getType() === "remote" ? transceiver.receiver.track : transceiver === null || transceiver === void 0 ? void 0 : (_transceiver$sender = transceiver.sender) === null || _transceiver$sender === void 0 ? void 0 : _transceiver$sender.track;
