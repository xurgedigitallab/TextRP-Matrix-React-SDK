...
class MediaTrackStats {
  constructor(trackId, type, kind) {
    ...
    this.type = type;
    this.kind = kind;
    (0, _defineProperty2.default)(this, "loss", {
      packetsTotal: 0,
      packetsLost: 0,
      isDownloadStream: false
    });
    (0, _defineProperty2.default)(this, "bitrate", {
      download: 0,
      upload: 0
    });
    (0, _defineProperty2.default)(this, "resolution", {
      width: -1,
      height: -1
    });
    (0, _defineProperty2.default)(this, "audioConcealment", {
      concealedAudio: 0,
      totalAudioDuration: 0
    });
    (0, _defineProperty2.default)(this, "framerate", 0);
    (0, _defineProperty2.default)(this, "jitter", 0);
    (0, _defineProperty2.default)(this, "codec", "");
    (0, _defineProperty2.default)(this, "isAlive", true);
    (0, _defineProperty2.default)(this, "isMuted", false);
    (0, _defineProperty2.default)(this, "isEnabled", true);
  }
  getType() {
    return this.type;
  }
...
//# sourceMappingURL=mediaTrackStats.js.map