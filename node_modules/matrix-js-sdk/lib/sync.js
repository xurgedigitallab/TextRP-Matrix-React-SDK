...
class SyncApi {
  ...
  async processSyncResponse(syncEventData, data) {
    var _data$presence, _data$account_data, _this$syncOpts$crypto2, _data$device_unused_f;
    const client = this.client;
    ...
    await ((_this$syncOpts$crypto2 = this.syncOpts.cryptoCallbacks) === null || _this$syncOpts$crypto2 === void 0 ? void 0 : _this$syncOpts$crypto2.processKeyCounts(data.device_one_time_keys_count, (_data$device_unused_f = data.device_unused_fallback_key_types) !== null && _data$device_unused_f !== void 0 ? _data$device_unused_f : data["org.matrix.msc2732.device_unused_fallback_key_types"]));
  }
