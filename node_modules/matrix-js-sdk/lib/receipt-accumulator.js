...
class ReceiptAccumulator {
  constructor() {
    ...
    (0, _defineProperty2.default)(this, "unthreadedReadReceipts", new Map());
    /** thread_id -\> user_id -\> most-recently-received receipt for this thread */
    (0, _defineProperty2.default)(this, "threadedReadReceipts", new _utils.MapWithDefault(() => new Map()));
  }
  /**
  ...
  *allThreaded() {
  ...
  consumeEphemeralEvents(events) {
    events === null || events === void 0 ? void 0 : events.forEach(e => {
