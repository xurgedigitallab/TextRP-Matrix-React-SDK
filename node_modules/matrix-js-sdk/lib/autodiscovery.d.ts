import { IClientWellKnown, IWellKnownConfig, IDelegatedAuthConfig } from "./client";
import { ValidatedIssuerConfig } from "./oidc/validate";
...
export declare class AutoDiscovery {
     ...
     */
    static validateDiscoveryAuthenticationConfig(wellKnown: IClientWellKnown): Promise<DelegatedAuthConfig | AutoDiscoveryState>;
    /**
