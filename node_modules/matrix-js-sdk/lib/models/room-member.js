...
class RoomMember extends _typedEventEmitter.TypedEventEmitter {
  ...
  setMembershipEvent(event, roomState) {
    ...
    const displayName = (_event$getDirectional = event.getDirectionalContent().displayname) !== null && _event$getDirectional !== void 0 ? _event$getDirectional : "";
    ...
    this.rawDisplayName = (0, _utils.removeDirectionOverrideChars)((_event$getDirectional2 = event.getDirectionalContent().displayname) !== null && _event$getDirectional2 !== void 0 ? _event$getDirectional2 : "");
