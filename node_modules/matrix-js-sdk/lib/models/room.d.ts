...
import { Thread, ThreadEvent, ThreadEventHandlerMap as ThreadHandlerMap } from "./thread";
...
export declare class Room extends ReadReceipt<RoomEmittedEvents, RoomEventHandlerMap> {
     ...
     */
    addLiveEvents(events: MatrixEvent[], duplicateStrategy?: DuplicateStrategy, fromCache?: boolean): Promise<void>;
