...
export function signingkeysuploadrequest_type(a: number): number;
...
export function signingkeysuploadrequest_new(a: number, b: number): number;
...
export function wasm_bindgen__convert__closures__invoke0_mut__had32310ecd4a8ead(a: number, b: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function wasm_bindgen__convert__closures__invoke1_mut__h8884baeee3f54fbb(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke1__hdb933fcba820c84b(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h056d4e82644be921(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h3c3c7d281be87475(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h7fb461730a32ec67(a: number, b: number, c: number, d: number): void;
